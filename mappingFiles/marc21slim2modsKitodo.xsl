<xsl:stylesheet xmlns:mods="http://www.loc.gov/mods/v3" xmlns:marc="http://www.loc.gov/MARC21/slim"
	...
	exclude-result-prefixes="xlink marc mods" version="1.0">
	...
	<xsl:template match="/">
		<xsl:choose>
			<xsl:when test="//marc:collection">
                <!-- eWW: modsCollection and mods elements are already created by Kitodo.Production export and therefor have to be skipped here -->
...
-->
		...
		<originInfo>
			...
			<!-- WLB: Ausgabe des Laendercodes (z.B. XA-DE) deaktiviert -->
			<!--
				...
				<place>
					<placeTerm>
						...
						<xsl:call-template name="chopPunctuationFront">
							<xsl:with-param name="chopString">
								<xsl:call-template name="chopPunctuation">
									<!-- WLB: es werden alle Textknoten unterhalb von tag 264 ausgegeben, benoetigt aber nur subfield a
									fehlerhaft bisher: <xsl:with-param name="chopString" select="."/>
									-->
		...
		<!-- WLB: Ausgabe der Sprache aus controlfield deaktiviert - waere dann gedoppelt mit tag 041
			ausserdem ist hier ein Fehler enthalten (z.B. Ausgabe "c" statt "ger" - falscher offset? Sprachcode steht in Beispieldaten in 32,3)
		-->
		<!--
